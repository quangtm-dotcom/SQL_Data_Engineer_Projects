...
SELECT '=== Loading company_dim Table ===' info;
...
SELECT '=== Loading skills_dim Table ===' info;
...
SELECT '=== Loading job_postings_fact Table ===' info;
...
SELECT '=== Loading skills_job_dim Table ===' info;
...
SELECT '=== Skill Job Dimension Sample ===' AS info;
